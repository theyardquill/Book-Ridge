...
function WhatsAppIcon({ size = 26, ...props }: WhatsAppIconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size} // Use the size prop
      height={size} // Use the size prop
      viewBox="0 0 30.667 30.667" // Keep the viewBox the same
      className="ionicon"
      {...props}
    >
      ...
      <g id="SVGRepo_iconCarrier">
        <g>
          ...
          <circle cx="15.333" cy="15.333" r="15.333" fill="#25D366" />
          {/* WhatsApp logo paths with white strokes */}
          <path
            ...
            fill="white" // White fill for the logo
            stroke="white" // White stroke for the logo
            strokeWidth="0.5" // Adjust stroke width as needed
            transform="scale(1.0) translate(-2.5, -2.5)" // Scale and translate the logo
          />
        </g>
      </g>
    </svg>
